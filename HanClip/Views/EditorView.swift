...
private struct ImportantInfoSheet: View {
    ...
    private let items: [(title: String, body: String)] = [
        ...
        ("영상 시간 필터", "사진 화면의 필터에서 설정한 시간 이상인 긴 영상만 찾는 기능입니다. 시간 필터를 적용하는 동안에는 사진과 라이브포토를 숨기고 영상만 표시합니다. 1분, 3분, 5분, 10분을 빠르게 고르거나 분과 초를 직접 선택할 수 있으며, 필터를 해제하면 이전에 선택했던 미디어 종류가 복원됩니다."),
